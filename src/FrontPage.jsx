...
// import CarbonEmissions from "./services";
  ...
  return (
    <nav className="navbar">
      ...
      <ul className="navlinks">
        <li><Link to="/TheThought">About</Link></li>
    ...
    <div>
      ...
      <div className="services-container">
        ...
        <div className="left-form-box"> 
          ...
          {/* <p style={{ fontSize: "12px", color: "white", marginTop: "1em" }}>Already registered</p> */}
...
export {Navbar, Mandavbar, Earth, TheThought, ContactUs, Footer};